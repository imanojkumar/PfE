...
# using the split() function. The program should build a list of words. For each word on each line check 
...
for line in fh: 
    for tmp in line.split(str):
        allList.append(tmp.rstrip())

tmp = set(allList)
allList = list(tmp)

print sorted(allList)
